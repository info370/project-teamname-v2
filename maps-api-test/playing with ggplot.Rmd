...
```{r}
col.names <- paste(c("Event.Clearance.Code", "cluster", "Census.Tract"), collapse="|")
...
train.data <- select(data, c("Event.Clearance.Code", "cluster", "Census.Tract", "District.Sector", "Longitude", "Latitude"))
data <- data %>% droplevels()
control <- trainControl(method="repeatedcv", number = 10, repeats = 3)

train.data
model <- train(Event.Clearance.Code ~., data=as.data.frame(train.data), method = "knn", preProcess = "scale", trControl = control)
