...
```{r}
ggmap(seattle) +
  geom_point(data = data.ped, aes(x = Longitude, y = Latitude, group = Event.Clearance.Group, color = Event.Clearance.Group), alpha = 1) +
  # facet_wrap(~ Event.Clearance.Group, ncol = 2) +
